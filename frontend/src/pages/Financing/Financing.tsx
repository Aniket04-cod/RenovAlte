...
const Financing: React.FC = () => {
    ...
    return (
      <div className="text-center py-12">
        ...
        <Text className="text-gray-600 mb-6">
          Please select a project from the Home page to access Financing options.
        </Text>
        <button
          onClick={() => navigate("/")}
  ...
  return (
    <div>
      <Heading level={1}>Financing</Heading>
      <Text className="text-gray-600 mb-6">
        Set up your Financing plan, timeline, and loans step by step for{" "}
        <span className="font-medium">{selectedProject.name}</span>.
      </Text>

      {/* Financing content will go here */}
      <div className="bg-white rounded-lg border border-gray-200 p-6">
        <Text className="text-gray-500">
          Financing options and tools will be available here for this project.
        </Text>
      </div>
    </div>
  );
